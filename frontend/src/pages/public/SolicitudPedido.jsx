    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="pt-32 text-center px-6">
          ...
          <h1 className="font-headline font-semibold text-2xl text-on-surface mb-4">
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-20 px-6 md:px-10 max-w-5xl mx-auto">
        ...
        <h1 className="font-headline font-semibold text-4xl text-on-surface mb-2">Solicitud de Pedido</h1>
