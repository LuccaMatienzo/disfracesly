  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-surface-container-lowest rounded-2xl shadow-card p-3 lg:p-5 flex flex-col gap-4">
        ...
        <div className="flex flex-row flex-nowrap w-full gap-2 items-center">
          ...
          <button
            ...
            className={`md:hidden flex-shrink-0 h-11 w-11 flex items-center justify-center rounded-xl transition-colors border ${
              showFilters || includeDeleted || sort.field
        ...
        {/* Barra de ordenamiento (Desktop) */}
        <div className="hidden md:flex flex-row flex-nowrap overflow-x-auto whitespace-nowrap gap-3 w-full pt-3 border-t border-divider items-center min-w-0 overflow-visible justify-start">
            ...
            <div className="flex flex-col gap-6 overflow-y-auto pb-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-surface-container-low border border-divider rounded-xl p-3 flex items-center justify-center">
                    <SortToggle label="Nombre" field="nombre" currentSort={sort} onSortChange={handleSortChange} />
                  </div>
                  <div className="bg-surface-container-low border border-divider rounded-xl p-3 flex items-center justify-center">
                    <SortToggle label="Apellido" field="apellido" currentSort={sort} onSortChange={handleSortChange} />
                  </div>
                  <div className="bg-surface-container-low border border-divider rounded-xl p-3 flex items-center justify-center">
                    <SortToggle label="Fecha de Alta" field="fecha_alta" currentSort={sort} onSortChange={handleSortChange} />
                  </div>
                  <div className="bg-surface-container-low border border-divider rounded-xl p-3 flex items-center justify-center">
                    <SortToggle label="Documento" field="documento" currentSort={sort} onSortChange={handleSortChange} />
                  </div>
                </div>
              </div>
            </div>
